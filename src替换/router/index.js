...
export const constantRoutes = [
  ...
  {
    path: '/charts',
    component: (resolve) => require(['@/views/baidan/charts'], resolve),
    hidden: true,
      
  },
  {
    path: '/biaozh',
    component: (resolve) => require(['@/views/baidan/biaozh'], resolve),
    hidden: true,
  ...
  
  {
    ...
    children: [
      {
        path: 'type/data/:daynotecfgId(\\d+)',
        component: (resolve) => require(['@/views/work/daynotecfg/data'], resolve),
        name: 'Data',
        meta: { title: '修改工作日志模板', icon: '' }
      }
    ]
  }
]
...
export default new Router({
  ...
  mode: 'hash', // url中的# 20210720 修改为hash模式
  scrollBehavior: () => ({ y: 0 }),
