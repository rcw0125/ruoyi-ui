...
<!-- 
     ...
     <el-form ref="form" :model="form" :rules="rules" v-if="open" label-width="80px">
        ...
        <!-- <el-form-item label="技术频道" prop="channelId">
            <treeselect v-model="form.channelId" :options="deptOptions" :normalizer="normalizer" :show-count="true" placeholder="请选择归属部门" />
        </el-form-item> -->
         <el-row>
         ...
         <!-- <el-button type="primary" @click="submitForm">确 定 发 布 文 章</el-button>
         ...
         <el-row>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <el-form-item label="技术频道" prop="channelId">
          <treeselect v-model="form.channelId" :options="deptOptions" :normalizer="normalizer" placeholder="技术频道" />
        </el-form-item>
          </el-col> 
        </el-row>
        <!-- <el-form-item label="技术频道" prop="channelId">
    ...
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-if="!open" v-show="showSearch" label-width="68px">
      <!-- <el-form-item label="文章所在分类专栏Id" prop="classifyId">
        <el-input
    ...
    <el-row :gutter="10" v-if="!open" class="mb8">
      <el-col :span="1.5">
        <el-button
          type="primary"
          plain
