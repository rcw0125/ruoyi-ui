    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="故障内容" prop="djcontent">
          <el-input v-model="form.djcontent" type="textarea" rows="3" readonly placeholder="请输入内容" />
        </el-form-item>
        ...
        <el-form-item label="故障大类" prop="jsclfl">
          <el-input v-model="form.jsclfl" readonly placeholder="请选择故障大类" />
...
<script>
import { listGuzhang, getGuzhang, delGuzhang, addGuzhang, updateGuzhang, exportGuzhang ,getAddInfo,listYzGuzhang,confirmGuzhang} from "@/api/system/guzhang";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listYzGuzhang(this.queryParams).then(response => {
    ...
    //   this.gzxlOptions = response.data;
    // });
    // },
    /** 查询部门下拉树结构 */
