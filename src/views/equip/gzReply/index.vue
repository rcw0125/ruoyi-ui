...
<script>
import { listGuzhang, getGuzhang, delGuzhang, addGuzhang, updateGuzhang, exportGuzhang ,getAddInfo,listClGuzhang,replyGuzhang,gzDeptGuzhang} from "@/api/system/guzhang";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listClGuzhang(this.queryParams).then(response => {
