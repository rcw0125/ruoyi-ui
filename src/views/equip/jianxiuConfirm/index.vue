<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm"   :inline="true" v-show="false" label-width="68px">
      ...
      <el-form-item label="状态" prop="status">
        <el-select v-model="queryParams.status" placeholder="请选择状态(等待检修、检修完成、异常结束)" clearable size="small">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['system:jianxiu:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="jianxiuList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="设备名称" align="center" width="200px" prop="sbname" />
      <!-- <el-table-column label="检修单位" align="center" prop="dept" /> -->
      <el-table-column label="检修班组" align="center" prop="team" />
      <el-table-column label="计划人" align="center" prop="jhr" />
      <el-table-column label="计划日期" align="center" prop="jhrq" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.jhrq, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <!-- <el-table-column label="登记时间" align="center" prop="djtime" /> -->
      <el-table-column label="检修内容" align="center" width="200px" prop="jxnr" />
      <!-- <el-table-column label="检修描述" align="center" prop="jxms" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="检修班组"  v-show="false"  prop="team">
        ...
        <el-form-item label="计划人"  prop="jhr">
          <el-input v-model="form.jhr" readonly placeholder="请输入计划人" />
        </el-form-item>
        <el-form-item label="计划日期" prop="jhrq">
          <el-date-picker clearable readonly size="small"
            v-model="form.jhrq"
            type="date"
            value-format="yyyy-MM-dd"
            placeholder="选择计划日期">
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.queryParams.team=this.team;
      this.queryParams.status="等待检修";
