<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="kaoheList"  @selection-change="handleSelectionChange" @row-dblclick="dbSelected">
      ...
      <el-table-column label="考评原因" align="center" prop="khnote" width="500" />
...
<script>
import { listMyKaohe, getKaohe, delKaohe, addKaohe, updateKaohe, exportKaohe } from "@/api/system/kaohe";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listMyKaohe(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
