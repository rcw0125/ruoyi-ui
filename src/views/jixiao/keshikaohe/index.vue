        ...
        <el-row>
          ...
          <!-- <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
             <el-form-item label="安全扣分" prop="aqkf">
              <el-input oninput="value=value.replace(/[^\d.]/g,'')" maxlength="8" v-model="form.aqkf" />
            </el-form-item>
          </el-col> -->
        </el-row>
        <el-row>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item   prop="khtype">
              <el-input v-model="form.khtype" v-show="false" placeholder="科室考评" > </el-input>
            </el-form-item>
          </el-col>
        </el-row>              
...
<script>
import {  addKaohe,listLgUser_user,treeselect_lg_dept } from "@/api/system/kaohe";
...
export default {
    ...
    return {
      ...
      // 表单校验
       rules: {
        ...
        khdj: [
          { required: true, message: "考核等级不能为空", trigger: "blur" }
        ],
        khxz: [
  ...
  created() {
    ...
    var now = new Date();
      ...
      //  this.$set(this.form, "aqkf", 0);
       ...
       this.$set(this.form, "khtype", "科室考评");
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listLgUser_user(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
    ...
    /** 查询部门下拉树结构 */
    getTreeselect() {
      treeselect_lg_dept().then(response => {
