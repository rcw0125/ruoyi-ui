        ...
        <el-row>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <el-form-item   prop="khtype">
              <el-input v-model="form.khtype"  v-show="false"  placeholder="相关方考评" />
            </el-form-item>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="考核原因" prop="khnote">
              <el-input v-model="form.khnote"  :rows="5" type="textarea" placeholder="请输入考核原因"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
...
<script>
import {  addKaohe,treeselect_wf_dept,listWfUser_user } from "@/api/system/kaohe";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listWfUser_user(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
    ...
    /** 查询部门下拉树结构 */
    getTreeselect() {
      treeselect_wf_dept().then(response => {
