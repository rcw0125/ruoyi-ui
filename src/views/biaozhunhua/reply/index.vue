  ...
  <div class="app-container">
    ...
    >
      ...
      >
        ...
        <el-form-item label="整改图片" v-show="replyform.checkpicture != null">
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listReplyBzhjc(this.addDateRange(this.queryParams, this.dateRange)).then((response) => {
