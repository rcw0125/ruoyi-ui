  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="chejopen" width="600px" append-to-body>
      <el-form ref="chejform" :model="chejform" :rules="rules" label-width="80px">
        ...
        <el-form-item label="审核科室" v-show=" chejform.shuxing=='班组'" prop="shks">
...
<script>
import { getChjList,listZizhugaishan, getZizhugaishan, delZizhugaishan,getUpdateInfo, addZizhugaishan, updateZizhugaishan, exportZizhugaishan,getChjInfo,getKesInfo,getJybInfo,chjShh,kesShh,jybShh } from "@/api/system/zizhugaishan";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      getChjList(this.queryParams).then(response => {
          ...
          if (this.chejform.id != null) {
            if(this.chejform.status=="车间审核未通过"){
              if(this.chejform.reason==null){
               ...
               if(this.chejform.shks==null &&this.chejform.shuxing=='班组'){
