...
<script>
import { listMyCarinfo, getCarinfo, delCarinfo, addCarinfo, updateCarinfo, exportCarinfo } from "@/api/system/carinfo";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listMyCarinfo(this.queryParams).then(response => {
