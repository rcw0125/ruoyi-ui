  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="车型" prop="cartype">
        <el-select v-model="queryParams.cartype" placeholder="请选择车型" clearable size="small">
          <el-option
      ...
      <!-- <el-form-item label="收费方式" prop="shoufeifangshi">
        <el-input
          v-model="queryParams.shoufeifangshi"
          placeholder="请输入收费方式"
          clearable
          size="small"
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:carcfg:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:carcfg:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="carcfgList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="收费方式" align="center" prop="shoufeifangshi" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="单价" prop="danjia">
          <el-input oninput="value=value.replace(/[^\d.]/g,'')" maxlength="8" v-model="form.danjia"  placeholder="请输入单价" />
        </el-form-item>
        <el-form-item label="备注" prop="beizhu">
          <el-input type="textarea" v-model="form.beizhu"  placeholder="请输入备注" />
        </el-form-item>
      </el-form>
...
<script>
import { listCarcfg, getCarcfg, delCarcfg, addCarcfg, updateCarcfg, exportCarcfg } from "@/api/system/carcfg";
  ...
  methods: {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            updateCarcfg(this.form).then(response => {
              this.msgSuccess("修改成功");
              this.open = false;
              this.getList();
            });
          } else {
            addCarcfg(this.form).then(response => {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有用车台账数据项?', "警告", {
          ...
          return exportCarcfg(queryParams);
        }).then(response => {
