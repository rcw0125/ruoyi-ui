      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="部门" align="center" key="deptName" prop="dept.deptName" v-if="columns[3].visible" :show-overflow-tooltip="true" />
           <el-table-column label="班别" align="center" key="team" prop="team"  />
          <el-table-column prop="roles" label="角色" width="">
                 <template slot-scope="scope">
                    <el-tag v-for="item in scope.row.roles" :key="item.roleId" >{{item.roleName}}</el-tag>
                </template>
            </el-table-column>
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
          <el-col :span="24">
            ...
            <el-form-item label="用户顺序" prop="roleSort">
          <el-input-number v-model="form.user_sort" controls-position="right" :min="0" />
        </el-form-item>
        </el-row>
      </el-form>
